...
class AppointmentDoctorWeb extends StatefulWidget {
  final DoctorModel doctor;
  final double widthSizedBox;

  const AppointmentDoctorWeb({
    Key? key,
  ...
  @override
  State<AppointmentDoctorWeb> createState() => _AppointmentDoctorWebState();
}

class _AppointmentDoctorWebState extends State<AppointmentDoctorWeb> {
