...
class DetailAppointmentMobile extends StatefulWidget {
  final AppointmentModel appointment;

  const DetailAppointmentMobile({
    Key? key,
    required this.appointment,
  }) : super(key: key);

  @override
  State<DetailAppointmentMobile> createState() =>
      _DetailAppointmentMobileState();
}

class _DetailAppointmentMobileState extends State<DetailAppointmentMobile> {
  @override
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(
                      builder: (context) {
                        return DetailDoctor(doctor: widget.appointment.doctor);
                      },
                    ));
                  },
